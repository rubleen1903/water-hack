...
const FeaturesTiles = ({
  ...
  const sectionHeader = {
    title: '9 best ways to save water',
    paragraph: "97.5% of the world’s water is locked in seas and oceans, too salty for human use. And most of the remaining 2.5% is in the ice caps."};
